...
sensor = 16  #MQ135 Alcohol sensor
GPIO.setmode(GPIO.BOARD)
GPIO.setup(sensor,GPIO.IN)
print ("Sensor Ready.....")
print (" ")
try:
    baseURL='https://api.thingspeak.com/update?api_key=32ZJBTDJ6H3RXKMQ'  #Update sensor data on the thingspeak channel 
    while True:
        if GPIO.input(sensor>50):
            print("Alcohol intoxication detected")
        else:
            print("Not Detected")
        s=baseURL+"&field1=%s"%(sensor)
